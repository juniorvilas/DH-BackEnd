...
public class PacienteServiceTest {
    ...
    public static void carregarDados() {
        Endereco endereco = new Endereco(
                "Av Santa fe", "444", "São Paulo", "São Paulo");
        Paciente p = pacienteService.cadastrar(new Paciente(
                "Vicente", "Santos", "88888888", new Date(), endereco));
        Endereco endereco1 = new Endereco(
                "Av das Margaridas", "333", "Belo Horizonte", "Minas Gerais");
        Paciente p1 = pacienteService.cadastrar(new Paciente(
                "Marcela", "Moura", "99999999", new Date(), endereco1));
